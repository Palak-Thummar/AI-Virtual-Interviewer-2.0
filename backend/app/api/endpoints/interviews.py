...
async def list_interviews(current_user_id: str = Depends(get_current_user)):
    ...
    for interview in interviews:
        ...
        skill_breakdown = interview.get("skill_scores") or interview.get("skill_breakdown") or {
            "DSA": 0,
            "System Design": 0,
            "Behavioral": 0,
            "Communication": 0,
        ...
        score = round(float(interview.get("score", interview.get("total_score", interview.get("overall_score", 0))) or 0), 2)
        ...
        response.append(
            {
                ...
                "updated_at": interview.get("updated_at").isoformat() if isinstance(interview.get("updated_at"), datetime) else interview.get("updated_at"),
